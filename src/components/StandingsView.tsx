    ...
    if (totalMatchesPlayed === 0) {
        return (
            <div className="glass rounded-xl p-20 text-center border border-white/5 shadow-2xl">
                ...
                <p className="text-foreground/40 max-w-md mx-auto font-medium">
                    The tournament for this season hasn't started or no matches have been completed. Check back soon for live rankings!
                </p>
            </div>
        );
    }
